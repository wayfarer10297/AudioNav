...
Data associated with .mp3 audio files for the Announcer
...
#define NO_GPS_FIX_AVAILABLE    speak[42]
...
void load_speak_array(){
	...
	speak[42] = "/msg/fix_quality_poor.mp3"; //Placeholder: RECORDING NEEDED HERE!
	// Numbers-point
